...
RUN wget -O - https://packages.windmaker.net/WINDMAKER-GPG-KEY.pub | apt-key add
RUN echo "deb https://packages.windmaker.net/ any main" > /etc/apt/sources.list.d/windmaker.list
